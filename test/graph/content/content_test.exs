defmodule Graph.ContentTest do
  use Graph.DataCase
  ...
  describe "posts" do
    ...
    @valid_attrs %{body: "some body", created: ~N[2010-04-17 14:00:00.000000], description: "some description", title: "some title"}
    @update_attrs %{body: "some updated body", created: ~N[2011-05-18 15:01:01.000000], description: "some updated description", title: "some updated title"}
    @invalid_attrs %{body: nil, created: nil, description: nil, title: nil}
    ...
    test "create_post/1 with valid data creates a post" do
      ...
      assert post.created == ~N[2010-04-17 14:00:00.000000]
    ...
    test "update_post/2 with valid data updates the post" do
      ...
      assert post.created == ~N[2011-05-18 15:01:01.000000]
